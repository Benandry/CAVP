...
return [
    ...
    'download_etat' => [['id'], ['id' => '', '_controller' => 'App\\Controller\\MouvementController::impressionPdf'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/impression_product']], [], [], []],
    ...
    'periode_mensuel' => [['mois'], ['mois' => '', '_controller' => 'App\\Controller\\PeriodeController::mensuel'], [], [['variable', '/', '[^/]++', 'mois', true], ['text', '/etat-de-stocks']], [], [], []],
