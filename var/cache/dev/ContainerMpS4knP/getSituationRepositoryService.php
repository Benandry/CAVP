 ...
 */
class getSituationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SituationRepository' shared autowired service.
     *
     * @return \App\Repository\SituationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SituationRepository.php';

        return $container->privates['App\\Repository\\SituationRepository'] = new \App\Repository\SituationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
