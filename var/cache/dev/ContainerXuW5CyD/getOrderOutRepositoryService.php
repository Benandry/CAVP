 ...
 */
class getOrderOutRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OrderOutRepository' shared autowired service.
     *
     * @return \App\Repository\OrderOutRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OrderOutRepository.php';

        return $container->privates['App\\Repository\\OrderOutRepository'] = new \App\Repository\OrderOutRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
