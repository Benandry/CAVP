...
return [
    ...
    'select' => [[], ['_controller' => 'App\\Controller\\EtatController::select'], [], [['text', '/select_product']], [], [], []],
    ...
    'precision_date' => [[], ['_controller' => 'App\\Controller\\HistoriqueController::specify'], [], [['text', '/modification-de-la-date']], [], [], []],
    'download_etat' => [[], ['_controller' => 'App\\Controller\\MouvementController::impressionPdf'], [], [['text', '/download-etat-de-stock-generaliser']], [], [], []],
    'impression_product' => [['id'], ['_controller' => 'App\\Controller\\MouvementController::impressionAero'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/impression_product']], [], [], []],
    'order_out' => [[], ['_controller' => 'App\\Controller\\OrderController::index'], [], [['text', '/ordre-de-sortie']], [], [], []],
    'periode_mensuel' => [[], ['_controller' => 'App\\Controller\\PeriodeController::mensuel'], [], [['text', '/etat-de-stock-par-mois']], [], [], []],
