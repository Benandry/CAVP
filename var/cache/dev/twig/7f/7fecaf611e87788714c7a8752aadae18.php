...
/* etat/taxes.html.twig */
class __TwigTemplate_77373a43196df39183767e89be023697 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "etat/taxes.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "etat/taxes.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "etat/taxes.html.twig", 1);
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Produits Chiffres Taxes | Paositra malagasy! ";
...
";
    ...
    ";
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 87
        echo "<h4 class=\"text-danger\"><label for=\"cars\">Nom du produits :<em>Chiffres Taxes</em></h4>  
...
$context["key2"] == "actuelle")) {
        ...
        echo "
                                        <p> <a href=\"";
        // line 167
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("down_chiffres_taxes");
...
{% block title %}Produits Chiffres Taxes | Paositra malagasy! {% endblock %}
...
{% endfor %}
{# ------------------------#}
    <h4 class=\"text-danger\"><label for=\"cars\">Nom du produits :<em>Chiffres Taxes</em></h4>  
    <select name=\"link\" id='' size=\"1\" onchamge=\"window.location.href=this.value;\">
                            ...
                            <div class=\"q-display p-3\">
                                ...
                                <div class=\"d-flex flex-row-reverse bd-highlight\">
                                    <div class=\"p-2 bd-highlight\">
                                        ...
                                        <p><span> Chef de  Centre d'Approvisionnement en Valeurs Postales </span></p>
                                            {{ app.user.prenom }}
                                        <p> <a href=\"{{ path('down_chiffres_taxes') }}\" style=\"color: #fff; text-decoration:none;\"><button class=\"btn btn-outline-danger\" >Imprimer ce fichier</button></a></p>                                        </p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
", "etat/taxes.html.twig", "C:\\Users\\Nandry\\Desktop\\CAVP\\templates\\etat\\taxes.html.twig");
    }
}
