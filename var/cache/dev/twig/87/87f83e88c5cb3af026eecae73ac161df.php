...
/* historique/history_integreted.html.twig */
class __TwigTemplate_931df7b7e16cfd439454722e66b07c3d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "historique/history_integreted.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "historique/history_integreted.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "historique/history_integreted.html.twig", 1);
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Compte rendu des produits entrées | Paositra Malagasy";
    ...
    <h1 class=\"q-title\"> Compte rendu produits Reintegrées  </h1>
    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["histo"]) {
                   ...
                   <div class=\"box-element card card-solid\" style=\"margin: 20px;\">
                        <div class=\"card card-body\">
                            <h4 style=\"display: flex;\"><img src=\"/images/calendrier.png\" width=\"30\" height=\"35\"> : 
                                ...
                                ";
            // line 29
            echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatDate($this->env, twig_get_attribute($this->env, $this->source, $context["histo"], "dat", [], "any", false, false, false, 29), "medium", "", null, "gregorian", "fr"), "html", null, true);
            echo "
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["histo"], "product", [], "any", false, false, false, 33), "html", null, true);
            echo "</span> <p>
                            <p> Categorie : <span style=\"color:#498000;\">";
            // line 34
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["histo"], "categorie", [], "any", false, false, false, 34), "html", null, true);
            echo "</span> <p>
                            <p> Action : <span style=\"color:#498000;\">";
            // line 35
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["histo"], "descriptions", [], "any", false, false, false, 35), "html", null, true);
            echo "</span> <p>
                            <p><u>Nombre voulu:</u> <span style=\"color:#498000;\">";
            // line 36
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["histo"], "nombre", [], "any", false, false, false, 36), "html", null, true);
            echo "</span> <p>
                            <p> Reference : <span style=\"color:#498000;\">";
            // line 37
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["histo"], "reference", [], "any", false, false, false, 37), "html", null, true);
            echo "</span> <p>
                            <p> Destination : <span style=\"color:#498000;\">";
            // line 38
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["histo"], "destination", [], "any", false, false, false, 38), "html", null, true);
            echo "</span> <p>
                        </div>
                    </div>
                </div>
...
";
    ...
    {
        return "historique/history_integreted.html.twig";
    }
    ...
    {
        return array (  175 => 43,  164 => 38,  160 => 37,  156 => 36,  152 => 35,  148 => 34,  142 => 33,  135 => 29,  127 => 23,  123 => 22,  116 => 20,  108 => 15,  104 => 14,  100 => 13,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
                ...
                <div class=\"col-lg-4 col-sm-6\" >
                   ...
                   <div class=\"box-element card card-solid\" style=\"margin: 20px;\">
                        <div class=\"card card-body\">
                            ...
                            <p> Action : <span style=\"color:#498000;\">{{ histo.descriptions }}</span> <p>
                            <p><u>Nombre voulu:</u> <span style=\"color:#498000;\">{{ histo.nombre }}</span> <p>
