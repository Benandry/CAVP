...
class __TwigTemplate_34a4bc90a86f35d0aae809ce8fe64854 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
       ...
       ";
            ...
            if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "label", [], "any", false, false, false, 9))) {
                ...
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "label", [], "any", false, false, false, 9)), "html", null, true);
                echo "</span>";
            }
            // line 10
            echo "</a>
...
($context["action"] ?? null), "htmlElement", [], "any", false, false, false, 11))) {
        ...
        <span class=\"btn-label\">";
            ...
            if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "label", [], "any", false, false, false, 15))) {
                echo "<span class=\"action-label\">";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "label", [], "any", false, false, false, 15)), "html", null, true);
                echo "</span>";
            }
            // line 16
            echo "</span>
...
";
    ...
    {
        return new Source("", "@EasyAdmin/crud/action.html.twig", "C:\\Users\\Nandry\\Desktop\\CAVP\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\crud\\action.html.twig");
    }
}
